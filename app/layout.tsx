...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Stream 26,000+ live channels in 4K with zero buffering. Sports, movies, series and more. Free trial included. Instant activation.',
  ...
  twitter: {
    ...
    title: 'Varodatic IPTV — 26,000+ Channels in 4K | Free Trial',
    description: 'Stream 26,000+ live channels in 4K. Zero buffering, free trial, instant setup.',
