...
const tierLabels: Record<string, string> = {
  "1 Connection": "1 Connessione",
  "2 Connections": "2 Connessioni",
  "3 Connections": "3 Connessioni",
};
...
function formatSaving(saving: string | null): string | null {
  ...
  if (match) return `Risparmia ${match[1]} CHF`;
  return saving;
}

export default function ItPricingSection() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 text-center glass rounded-2xl p-8 max-w-3xl mx-auto border-white/10">
          <p className="text-lg text-white mb-6">
            🎯 Non sei sicuro? Inizia la tua{" "}
            <span className="font-bold text-primary">PROVA GRATUITA</span> — Senza carta di credito.
          </p>
          <a
            href="https://wa.me/447476603520?text=Ciao%2C%20voglio%20iniziare%20la%20prova%20gratuita"
            target="_blank"
            rel="noopener noreferrer"
