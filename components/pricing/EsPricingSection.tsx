...
const tierLabels: Record<string, string> = {
  ...
  "2 Connections": "2 Conexiones",
  "3 Connections": "3 Conexiones",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          (pricingData.tiers[activeTier] as { note?: string }).note && (
            <div className="text-center mb-8 relative top-[-2rem]">
              <span className="text-xs text-primary bg-primary/10 border border-primary/20 px-3 py-1 rounded-full">
                Precio con descuento — precio original tachado
              </span>
            </div>
          )}
        ...
        <div className="mt-20 text-center glass rounded-2xl p-8 max-w-3xl mx-auto border-white/10">
          <p className="text-lg text-white mb-6">
            🎯 ¿No estás seguro? Empieza tu{" "}
            <span className="font-bold text-primary">prueba GRATUITA</span> — Sin tarjeta de crédito.
          </p>
          <a
            href="https://wa.me/447828708540?text=Hola%2C%20quiero%20iniciar%20la%20prueba%20gratuita"
            target="_blank"
            rel="noopener noreferrer"
