...
export default function EsHeroSection() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-left">
          ...
          >
            ...
            <span className="text-[11px] font-bold tracking-[0.2em] text-white uppercase">En Directo: Serie Masters 4K</span>
          </motion.div>
          ...
          >
            Varodatic IPTV España — +26.000 Canales en 4K | Prueba Gratis<br />
          ...
          >
            Varodatic te ofrece IPTV premium con más de 26.000 canales en directo — incluyendo Movistar+, DAZN, TVE y Antena 3 — 80.000+ títulos VOD y streaming 4K cristalino. Sin buffering, activación instantánea y prueba gratis incluida.
          </motion.p>
        ...
        >
          <div className="relative w-full aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
            <Image
              ...
              alt="Varodatic IPTV España — Más de 26.000 canales en vivo en calidad 4K sin buffering"
              fill
            ...
            <div className="absolute bottom-8 left-8">
              <span className="text-primary text-xs font-bold tracking-widest uppercase mb-1 block">Reproduciendo</span>
