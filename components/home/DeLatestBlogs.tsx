...
export default function DeLatestBlogs() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#A0A0A0] text-lg max-w-2xl mx-auto">
            Anleitungen, Tipps und Einrichtungs-Tutorials, um das Beste aus deinem Varodatic IPTV Schweiz Abonnement herauszuholen.
          </p>
        </div>
