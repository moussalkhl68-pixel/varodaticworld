...
export default function EsStatsBar() {
  const { ref, inView } = useInView({ threshold: 0.1, triggerOnce: true });

  const stats = [
    { label: "Usuarios Activos", value: 154000, suffix: "+" },
    { label: "Canales en Vivo", value: 26000, suffix: "+" },
    { label: "Títulos VOD", value: 100000, suffix: "+" },
    { label: "Disponibilidad", value: 99.9, suffix: "%" },
  ];
