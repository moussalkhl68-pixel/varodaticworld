export default function DeCompatibilityGrid() {
  const devices = [
    { name: "Smart TV", icon: "📺" },
  ...
  return (
    <section className="py-24 relative bg-surface border-y border-white/10" id="geraete">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">

        <div className="mb-16">
          <h2 className="text-3xl md:text-5xl font-heading font-bold text-white mb-6">
            Kompatibel mit <span className="text-primary">allen deinen Geräten.</span>
          </h2>
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Ob zuhause auf dem Grossbildschirm oder unterwegs mit dem Smartphone — dein Varodatic-Abonnement ist immer dabei. Verbinde bis zu 3 Geräte gleichzeitig mit unseren Premium-Paketen.
          </p>
        </div>
