...
export default function FrHeroSection() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-left">
          ...
          >
            ...
            <span className="text-[11px] font-bold tracking-[0.2em] text-white uppercase">En Direct: Ligue des Champions 4K</span>
          </motion.div>
          ...
          >
            Varodatic IPTV Suisse — 26&apos;000+ Chaînes en 4K | Essai Gratuit<br />
          ...
          >
            Varodatic vous offre l&apos;IPTV premium avec plus de 26&apos;000 chaînes en direct — RTS Un, RTS Deux, RTS Info, Canal+, TF1 et bien plus — 80&apos;000+ titres VOD et un streaming 4K cristallin. Sans coupure, activation instantanée, essai gratuit inclus.
          </motion.p>
        ...
        >
          <div className="relative w-full aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
            <Image
              ...
              alt="Varodatic IPTV Suisse Romande — Plus de 26'000 chaînes en direct en 4K sans coupure"
              fill
            ...
            <div className="absolute bottom-8 left-8">
              <span className="text-primary text-xs font-bold tracking-widest uppercase mb-1 block">En cours</span>
