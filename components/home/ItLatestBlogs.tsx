...
export default function ItLatestBlogs() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#A0A0A0] text-lg max-w-2xl mx-auto">
            Guide, consigli e tutorial di configurazione per ottenere il massimo dal tuo abbonamento Varodatic IPTV Svizzera.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 text-[#A0A0A0] text-xs mb-3">
                  <span>{new Date(post.date).toLocaleDateString("it-CH", { year: "numeric", month: "short", day: "numeric" })}</span>
                  <span>·</span>
