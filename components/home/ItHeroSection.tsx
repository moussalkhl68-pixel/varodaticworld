      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-left">
          ...
          >
            ...
            <span className="text-[11px] font-bold tracking-[0.2em] text-white uppercase">In Diretta: Serie A & Champions League 4K</span>
          </motion.div>
          ...
          >
            Varodatic IPTV Svizzera — 26.000+ Canali in 4K | Prova Gratuita<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">
              Nessun Buffering. Mai.
            </span>
          </motion.h1>
          ...
          >
            Varodatic offre IPTV premium con oltre 26.000 canali in diretta — RSI LA 1, RSI LA 2, Rai 1, Rai 2, DAZN e molti altri — 80.000+ titoli VOD e streaming 4K cristallino. Nessun buffering, attivazione istantanea, prova gratuita inclusa.
          </motion.p>
        ...
        >
          <div className="relative w-full aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
            <Image
              ...
              alt="Varodatic IPTV Svizzera — Oltre 26.000 canali in diretta in 4K senza buffering"
              fill
            ...
            <div className="absolute bottom-8 left-8">
              <span className="text-primary text-xs font-bold tracking-widest uppercase mb-1 block">In riproduzione</span>
