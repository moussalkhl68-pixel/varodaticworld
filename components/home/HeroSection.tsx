      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-left">
          ...
          >
            ...
            <span className="text-[11px] font-bold tracking-[0.2em] text-white uppercase">Live: 4K Masters Series</span>
          </motion.div>
          ...
          >
            Varodatic IPTV – 26,000+ Channels in 4K | Free Trial<br/>
          ...
          >
            Varodatic gives you premium IPTV with 26,000+ live channels, 80,000+ VOD titles, and crystal-clear 4K streaming — all with zero buffering, instant setup, and a free trial included.
          </motion.p>
          ...
          >
            ...
            <a href="/pricing" id="hero-cta-pricing" className="inline-flex justify-center items-center px-8 py-4 rounded-xl border border-white/10 bg-surface/50 text-white font-semibold text-lg hover:bg-surface transition-all duration-300 w-full sm:w-auto group">
        ...
        >
          <div className="relative w-full aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
            <Image 
              ...
              alt="Varodatic IPTV hero image showing premium 4K live channels and smooth streaming" 
              fill
            ...
            <div className="absolute bottom-8 left-8">
              <span className="text-primary text-xs font-bold tracking-widest uppercase mb-1 block">Now Playing</span>
