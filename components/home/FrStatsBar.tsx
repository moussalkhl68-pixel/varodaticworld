...
export default function FrStatsBar() {
  const { ref, inView } = useInView({ threshold: 0.1, triggerOnce: true });

  const stats = [
    { label: "Utilisateurs Actifs", value: 154000, suffix: "+" },
    { label: "Chaînes en Direct", value: 26000, suffix: "+" },
    { label: "Titres VOD", value: 100000, suffix: "+" },
    { label: "Disponibilité", value: 99.9, suffix: "%" },
  ];
