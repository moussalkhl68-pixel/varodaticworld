export default function FrCompatibilityGrid() {
  const devices = [
    { name: "Smart TV", icon: "📺" },
  ...
  return (
    <section className="py-24 relative bg-surface border-y border-white/10" id="appareils">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Que vous soyez chez vous sur grand écran ou en déplacement avec votre smartphone, votre abonnement Varodatic vous accompagne partout. Connectez jusqu&apos;à 3 appareils simultanément avec nos offres premium.
          </p>
        </div>
