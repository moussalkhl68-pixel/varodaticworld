...
export default function DeStatsBar() {
  const { ref, inView } = useInView({ threshold: 0.1, triggerOnce: true });

  const stats = [
    { label: "Aktive Nutzer", value: 154000, suffix: "+" },
    { label: "Live-Sender", value: 26000, suffix: "+" },
    { label: "VOD-Titel", value: 100000, suffix: "+" },
    { label: "Verfügbarkeit", value: 99.9, suffix: "%" },
  ];
